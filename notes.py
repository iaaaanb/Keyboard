...
# Equal-tempered scale with A4 = 440 Hz reference
...
NOTE_FREQUENCIES = {
    ...
    'A': {
        0: 27.50, 1: 55.00, 2: 110.00, 3: 220.00, 4: 440.00,  # A4 = 440 Hz
...
def get_frequency(note: str, octave: int) -> float:
    ...
    raise ValueError(f"Note {note}{octave} not found")

def is_valid_note(note: str, octave: int) -> bool:
    """Check if a note and octave combination is valid"""
    return note in NOTE_FREQUENCIES and octave in NOTE_FREQUENCIES[note]